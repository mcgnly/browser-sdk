window.RELAYR = (function(win, doc) {
    ...
    var util = {
        ...
        deviceConstructor: function(device) {
            device.delete = function(successCb, errorCb) {
                util.ajax({
                    url: self.config.url + "devices/" + device.deviceId,
                    type: "DELETE",
                    token: "Bearer " + self.account.token,
            ...
            device.update = function(options, successCb, errorCb) {
                if (!util.options) {
        ...
        transmitterConstructor: function(transmitter) {
            transmitter.delete = function(successCb, errorCb) {
                util.ajax({
            ...
            transmitter.update = function(options, successCb, errorCb) {
                if (!util.options) {
