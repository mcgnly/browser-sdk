window.RELAYR = (function(win, doc) {
    ...
    function Relayr(credentials) {
        ...
        function devices() {
            ...
            this.getDevice = function(device, successCb, errorCb) {
                if (!(device && device.deviceId)) {
                    throw new Error("Provide the deviceId within your parameters");
                }
            ...
            this.getDeviceState = function(device, successCb, errorCb) {
                if (!(device && device.deviceId)) {
                    throw new Error("Provide the deviceId within your parameters");
                }
            ...
            this.delete = function(device, successCb, errorCb) {
                if (!util.isAFunction(successCb)) {
                    throw new Error("Provide an success callback as an parameter");
                }
            ...
            this.update = function(device, options, successCb, errorCb) {
                // if (!this.options) {
                //     throw new Error("Provide something to update- your options are description, name, model, or public");
                // }
                if (!util.isAFunction(successCb)) {
                    throw new Error("Provide an success callback as an parameter");
                }
            ...
            this.sendCommand = function(device, successCb, errorCb) {
        ...
        function transmitters() {
            ...
            this.delete = function(transmitter, successCb, errorCb) {
                util.ajax({
                    url: self.config.url + "transmitters/" + transmitter.id,
                    type: "DELETE",
                    token: "Bearer " + self.account.token
                }, function(transmitter) {
                    successCb(transmitter);
                }, function(error) {
                    errorCb(error);
                });
                return this;
            ...
            this.update = function(transmitter, options, successCb, errorCb) {
                // if (!util.options) {
                //     throw new Error("Provide something to update- your options are name and maybe some other things?");
                // }
